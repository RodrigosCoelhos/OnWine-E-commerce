...
import { PortugueseStatesOptionSelect } from "../../Selects/PortugueseStatesOptionSelect";
...
export function FormDataLocal({
  ...
  const CepMaskPlaceHolder = "____-____";
        ...
        <Col md={12} xs={22}>
          <Form.Item label="Cidade" required>
            <Input
              ...
              name="cidade"
              size="middle"
              placeholder="Sua cidade, exemplo: Lisboa."
